                ...
                <form action="<?php echo FRONT_ROOT ?>Ticket/buyTicketView" method="post">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <?php if($show->getTicketsSold()<$show->getRoom()->getCapacity()){?>
                            <td> <button type="submit" class="btn btn-warning" name="movieShowId"
                                    value="<?php echo $show->getId(); ?>">BUY TICKET</button> </td>
                            <?php }else{?>
                            <td> TICKETS SOLD </td>
                            <?php } ?>
                        </tr>
